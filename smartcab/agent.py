...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.state_define = [
            ...
            ['red', 'green'],                   #light
            ['left', 'right', 'forward', None], #vehicle on left
            ['left', 'right', 'forward', None], #vehicle on right
            ['left', 'right', 'forward', None]  #vehicle oncoming
        ]

        self.dictionary = dict((key, 0.0) for key in self.valid_actions)

        for state_tuple in itertools.product(*self.state_define):
            self.Q[state_tuple] = self.dictionary.copy()
    ...
    def reset(self, destination=None, testing=False):
        ...
        # Use an exponentially decaying epsilon
    ...
    def createQ(self, state):
        ...
        if not state in self.Q:
            self.Q[state] = self.dictionary.copy()
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, alpha=0.001, epsilon=1)
